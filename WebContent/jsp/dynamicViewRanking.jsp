...
%>		<h2><%=tournament.getName()%></h2>
		...
		<display:table name="sessionScope.ranking" pagesize="20" uid="dynamicRanking">
...
if (nextPage > Math.ceil((double) nbPlayers / 20)) nextPage = 1;
String url = request.getContextPath() + "/jsp/dynamicViewRanking.jsp?" + paramName + "=" + nextPage;
%>		<script>
			newurl='<%=url%>';
