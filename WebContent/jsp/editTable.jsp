...
%>						<tr>
					...
					<thead>
						<tr>
							...
							<td class="columnPlayer"><jsp:getProperty property="player1Name" name="EditTableForm"/></td>
							<td class="columnPlayer"><jsp:getProperty property="player2Name" name="EditTableForm"/></td>
							<td class="columnPlayer"><jsp:getProperty property="player3Name" name="EditTableForm"/></td>
							<td class="columnPlayer"><jsp:getProperty property="player4Name" name="EditTableForm"/></td>
						</tr>
					</thead>
					<tbody>
<%
