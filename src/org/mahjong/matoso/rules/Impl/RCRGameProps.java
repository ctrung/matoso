...
public class RCRGameProps implements IGameProps {
	private static Logger LOGGER = Logger.getLogger(RCRGameProps.class);
	...
	public void updateGamePropsForOnePlayer(Player player, Integer scorePlayer, Integer scoreOtherPlayer1, Integer scoreOtherPlayer2,
		...
		if (scorePlayer.intValue() > 0) {
			...
			boolean selfpickAppeared = scoreOtherPlayer1 < 0 && scoreOtherPlayer2 < 0 && scoreOtherPlayer3 < 0;
